* Querys basadas en las User Historys*/
...
INSERT INTO lista_productos (id_productos, id_pedidos)
...
FROM pedidos pe
JOIN lista_productos lp ON pe.id_pedidos = lp.id_pedidos
JOIN productos p ON lp.id_productos = p.id_productos
WHERE pe.estado = 1
GROUP BY p.nombre;
